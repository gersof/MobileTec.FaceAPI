using MobileTec.FaceAPI.PoC.Web.Models;
using System;
...
namespace MobileTec.FaceAPI.PoC.Web.Helper
{
    /// <summary>
    /// UI helper functions
    /// </summary>
    internal static class UIHelper
    {
        ...
        public static IEnumerable<vmFace> CalculateFaceRectangleForRendering(IEnumerable<MobileTec.FaceAPI.PoC.FaceClient.Contract.Face> faces, int maxSize, Tuple<int, int> imageInfo)
        {
